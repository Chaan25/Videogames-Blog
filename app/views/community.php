...
<body>
	...
	<!-- Page info section -->
	<section class="page-info-section set-bg" data-setbg="public/pictures/page-top-bg/4.jpg">
	...
	<!-- Page section -->
	<section class="page-section community-page set-bg" data-setbg="public/pictures/community-bg.jpg">
