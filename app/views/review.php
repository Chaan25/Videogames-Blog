...
<body>
	...
	<!-- Page info section -->
	<section class="page-info-section set-bg" data-setbg="public/pictures/page-top-bg/3.jpg">
			...
			<div class="row">
				<div class="col-md-6">
					<div class="review-item">
						<div class="review-cover set-bg" data-setbg="public/pictures/review/5.jpg">
				...
				<div class="col-md-6">
					<div class="review-item">
						<div class="review-cover set-bg" data-setbg="public/pictures/review/6.jpg">
							<div class="score yellow">9.3</div>
						</div>
						<div class="review-text">
				...
				<div class="col-md-6">
					<div class="review-item">
						<div class="review-cover set-bg" data-setbg="public/pictures/review/7.jpg">
							<div class="score yellow">9.3</div>
						</div>
						<div class="review-text">
				...
				<div class="col-md-6">
					<div class="review-item">
						<div class="review-cover set-bg" data-setbg="public/pictures/review/8.jpg">
							<div class="score yellow">9.3</div>
						</div>
						<div class="review-text">
							<h4>Battlefront 2</h4>
				...
				<div class="col-md-6">
					<div class="review-item">
						<div class="review-cover set-bg" data-setbg="public/pictures/review/9.jpg">
							<div class="score yellow">9.3</div>
						</div>
						<div class="review-text">
							<h4>Battlefield V</h4>
				...
				<div class="col-md-6">
					<div class="review-item">
						<div class="review-cover set-bg" data-setbg="public/pictures/review/10.jpg">
							<div class="score yellow">9.3</div>
						</div>
						<div class="review-text">
							<h4>Vampyr</h4>
	...
	<!-- Review section -->
	<section class="review-section review-dark spad set-bg" data-setbg="public/pictures/review-bg-2.jpg">
		<div class="container">
